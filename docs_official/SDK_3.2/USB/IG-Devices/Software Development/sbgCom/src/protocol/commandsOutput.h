...
typedef enum _SbgAsciiOutputIds
{
	...
	SBG_OUTPUT_NMEA_HEHDT			= 0x04,					/*!< Standard NMEA output for True Heading angle */
	SBG_OUTPUT_ASCII_KVHEXT			= 0x05,					/*!< Proprietary ASCII output KVH Extended */
	SBG_OUTPUT_NMEA_HEHDM			= 0x06,					/*!< Standard NMEA output for "Magnetic Heading" angle same as HDT */
	SBG_OUTPUT_NMEA_PSXN23			= 0x07,					/*!< Proprietary NMEA sentence for roll, pitch, heading, and heave */
} SbgAsciiOutputIds;
